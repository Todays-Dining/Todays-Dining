...
public class ReviewandRating_Final extends JPanel {
	...
	public ReviewandRating_Final() {
		...
		backbutton.setIcon(new ImageIcon(ReviewandRating_Final.class.getResource("/image/backbutton.png")));
		...
		tabbedPane.addTab("", new ImageIcon(ReviewandRating_Final.class.getResource("/image/ReviewsandRating.png")), panel, "");
