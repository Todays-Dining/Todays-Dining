...
//	private JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Diner_Manage_x window = new Diner_Manage_x();
	...
	private void initialize() {
		...
		backbutton.setIcon(new ImageIcon(Diner_Manage_x.class.getResource("/image/backbutton.png")));
		...
		tabbedPane.addTab("", new ImageIcon(Diner_Manage_x.class.getResource("/image/DinerRevise.png")), panel_2, null);
		...
		tabbedPane.addTab("", new ImageIcon(Diner_Manage_x.class.getResource("/image/DinerNew.png")), panel_1, "");
