...
public class Main01_best3 extends JPanel {
	CardLayout cardLayout;
	JPanel main_pg;
	public JButton after_bt ;
	Start_frame main;
	
	public RoundedButton_kjh_5 store_bt ;
	public JLabel store_food_image3;
	public String store_name3;
	/**
	 * Create the application.
	 */
	public Main01_best3(CardLayout cardLayout, JPanel main_pg,Start_frame main) {
		...
		befer_bt.setIcon(new ImageIcon(Main01_best3.class.getResource("/image/beferbutton.png")));
		befer_bt.setBounds(0, 415, 69, 69);
		add(befer_bt);

		JButton after_bt = new JButton("");
		after_bt.setIcon(new ImageIcon(Main01_best3.class.getResource("/image/afterbutton.png")));
		...
		store_food_image3 = new JLabel();
		store_food_image3.setOpaque(true);
		store_food_image3.setHorizontalAlignment(SwingConstants.CENTER);
		store_food_image3.setForeground(new Color(255, 255, 255));
		store_food_image3.setFont(new Font("Sandoll 삼립호빵체 TTF Basic", Font.PLAIN, 50));
		store_food_image3.setBounds(54, 315, 429, 292);
		add(store_food_image3);
		...
		movemenu.setIcon(new ImageIcon(Main01_best3.class.getResource("/image/menubutton.png")));
		...
		homeButton.setIcon(new ImageIcon(Main01_best3.class.getResource("/image/homebutton_1.png")));
		...
		label_image.setIcon(new ImageIcon(Main01_best3.class.getResource("/image/label.png")));
		label_image.setBounds(0, 10, 540, 330);
		add(label_image);

		JLabel rank3_lb = new JLabel("평점 3위 ");
		rank3_lb.setHorizontalAlignment(SwingConstants.CENTER);
		rank3_lb.setFont(new Font("휴먼매직체", Font.BOLD, 30));
		rank3_lb.setBounds(127, 634, 297, 61);
		add(rank3_lb);
