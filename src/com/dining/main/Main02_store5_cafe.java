...
public class Main02_store5_cafe extends JPanel {
	...
	public Main02_store5_cafe(CardLayout cardLayout, JPanel main_pg, Start_frame main) {
		...
		JLabel store_lb = new JLabel("카페에서 뭐먹지?");
		...
		ib_img.setIcon(new ImageIcon(Main02_store5_cafe.class.getResource("/image/label.png")));
		ib_img.setBounds(0, 0, 540, 330);
		add(ib_img);

		JButton homebutton = new JButton("");
		homebutton.setBorderPainted(false);
		homebutton.setIcon(new ImageIcon(Main02_store5_cafe.class.getResource("/image/homebutton_1.png")));
