...
public class Main02_store2_american extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Main02_store2_american(CardLayout cardLayout, JPanel main_pg, Start_frame main) {
		...
		JLabel store_lb = new JLabel("양식 뭐먹지?");
		...
		ib_img.setIcon(new ImageIcon(Main02_store2_american.class.getResource("/image/label.png")));
		ib_img.setBounds(0, 0, 540, 330);
		add(ib_img);

		JButton homebutton = new JButton("");
		homebutton.setBorderPainted(false);
		homebutton.setIcon(new ImageIcon(Main02_store2_american.class.getResource("/image/homebutton_1.png")));
