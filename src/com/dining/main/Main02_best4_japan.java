...
public class Main02_best4_japan extends JPanel {
	...
	public Main02_best4_japan(CardLayout cardLayout, JPanel main_pg,Start_frame main) {
		...
		JLabel today = new JLabel("일식 BEST");
		...
		homeButton.setIcon(new ImageIcon(Main02_best4_japan.class.getResource("/image/homebutton_1.png")));
		homeButton.setBackground(new Color(255, 240, 245));
		homeButton.setBounds(327, 32, 77, 69);
		add(homeButton);

		JLabel lable_img = new JLabel("");
		lable_img.setIcon(new ImageIcon(Main02_best4_japan.class.getResource("/image/label.png")));
		lable_img.setBounds(0, 0, 540, 330);
		add(lable_img);

		RoundedButton_lsh_1 dif_japan_bt = new RoundedButton_lsh_1();
		dif_japan_bt.setText("다른 가게 보기(일식)");
		dif_japan_bt.setBorderPainted(false);
		dif_japan_bt.setOpaque(true);
		dif_japan_bt.setHorizontalAlignment(SwingConstants.CENTER);
		dif_japan_bt.setForeground(new Color(255, 255, 255));
		dif_japan_bt.setFont(new Font("Sandoll 삼립호빵체 TTF Outline", Font.BOLD, 20));
		dif_japan_bt.setBackground(new Color(65, 105, 225));
		dif_japan_bt.setBounds(157, 762, 223, 45);
		add(dif_japan_bt);
		...
		// main02_store4_japan로 이동
		dif_japan_bt.addActionListener(new ActionListener() {
