...
public class Main02_best1_korea extends JPanel {
	 ...
	 */
	public Main02_best1_korea(CardLayout cardLayout, JPanel main_pg,Start_frame main) {
		...
		JLabel today = new JLabel("한식 BEST");
		...
		homeButton.setIcon(new ImageIcon(Main02_best1_korea.class.getResource("/image/homebutton_1.png")));
		homeButton.setBackground(new Color(255, 240, 245));
		homeButton.setBounds(327, 32, 77, 69);
		add(homeButton);
		
		JLabel lable_img = new JLabel("");
		lable_img.setIcon(new ImageIcon(Main02_best1_korea.class.getResource("/image/label.png")));
		lable_img.setBounds(0, 0, 540, 330);
		add(lable_img);

		RoundedButton_lsh_1 dif_korea_bt = new RoundedButton_lsh_1();
		dif_korea_bt.setText("다른 가게 보기(한식)");
		dif_korea_bt.setBorderPainted(false);
		dif_korea_bt.setOpaque(true);
		dif_korea_bt.setHorizontalAlignment(SwingConstants.CENTER);
		dif_korea_bt.setForeground(new Color(255, 255, 255));
		dif_korea_bt.setFont(new Font("Sandoll 삼립호빵체 TTF Outline", Font.BOLD, 20));
		dif_korea_bt.setBackground(new Color(65, 105, 225));
		dif_korea_bt.setBounds(157, 762, 223, 45);
		add(dif_korea_bt);
		...
		// main02_store1_korea이동
		dif_korea_bt.addActionListener(new ActionListener() {
