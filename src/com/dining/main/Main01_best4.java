...
public class Main01_best4 extends JPanel {
	...
	JPanel main_pg;
	Start_frame main;
	public String store_name4;
	public JLabel store_food_image4;
	public RoundedButton_kjh_5 store_bt ;
	/**
	 * Create the application.
	 */
	public Main01_best4(CardLayout cardLayout, JPanel main_pg, Start_frame main) {
		...
		store_food_image4 = new JLabel();
		store_food_image4.setOpaque(true);
		store_food_image4.setHorizontalAlignment(SwingConstants.CENTER);
		store_food_image4.setForeground(new Color(255, 255, 255));
		store_food_image4.setFont(new Font("Sandoll 삼립호빵체 TTF Basic", Font.PLAIN, 50));
		store_food_image4.setBounds(54, 315, 429, 292);
		add(store_food_image4);
