...
public class  Main03_random extends JPanel{
	...
	public  Main03_random() {
		...
		add(image);
			...
			btnNewButton_2.setIcon(new ImageIcon("C:\\image\\111.png"));
			...
			btnNewButton_3.setIcon(new ImageIcon("C:\\image\\44.png"));
			btnNewButton_3.setBounds(309, 546, 86, 138);
			add(btnNewButton_3);
			
			JButton btnNewButton_4 = new JButton("New button");
			btnNewButton_4.setIcon(new ImageIcon("C:\\image\\33.png"));
			btnNewButton_4.setBounds(428, 546, 100, 138);
			add(btnNewButton_4);
			
			JButton btnNewButton_1 = new JButton("");
			btnNewButton_1.setIcon(new ImageIcon("C:\\image\\555.png"));
			btnNewButton_1.setBounds(169, 546, 113, 138);
			add(btnNewButton_1);
			
			JLabel lblNewLabel = new JLabel("");
			lblNewLabel.setIcon(new ImageIcon("C:\\image\\777777.png"));
