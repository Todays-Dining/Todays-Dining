...
public class Main02_best5_cafe extends JPanel {
	 ...
	 */
	public Main02_best5_cafe(CardLayout cardLayout, JPanel main_pg,Start_frame main) {
		...
		JLabel today = new JLabel("카페 BEST");
		...
		homeButton.setIcon(new ImageIcon(Main02_best5_cafe.class.getResource("/image/homebutton_1.png")));
		homeButton.setBackground(new Color(255, 240, 245));
		homeButton.setBounds(327, 32, 77, 69);
		add(homeButton);

		JLabel lable_img = new JLabel("");
		lable_img.setIcon(new ImageIcon(Main02_best5_cafe.class.getResource("/image/label.png")));
		lable_img.setBounds(0, 0, 540, 330);
		add(lable_img);

		RoundedButton_lsh_1 dif_cafe_bt = new RoundedButton_lsh_1();
		dif_cafe_bt.setText("다른 가게 보기(카페)");
		dif_cafe_bt.setBorderPainted(false);
		dif_cafe_bt.setOpaque(true);
		dif_cafe_bt.setHorizontalAlignment(SwingConstants.CENTER);
		dif_cafe_bt.setForeground(new Color(255, 255, 255));
		dif_cafe_bt.setFont(new Font("Sandoll 삼립호빵체 TTF Outline", Font.BOLD, 20));
		dif_cafe_bt.setBackground(new Color(65, 105, 225));
		dif_cafe_bt.setBounds(157, 762, 223, 45);
		add(dif_cafe_bt);
		...
		// main02_store5_cafe로 이동
		dif_cafe_bt.addActionListener(new ActionListener() {
